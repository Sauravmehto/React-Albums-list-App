                                ...
                                <React.Fragment>
                                    {
                                        (
                                            ...
                                            <div key={item.id} className="carousel-item active" data-bs-interval="5000" >
                                                ...
                                                {item.id === 1 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/614/132/HD-wallpaper-anime-landscape-sunset-clouds-falling-stars-anime-girl-scenery-anime.jpg" alt="..." />}
                                                {item.id === 11 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/695/161/HD-wallpaper-anime-scenery-sunset-anime-school-girl-clouds-artwork-anime.jpg" alt="..." />}
                                                {item.id === 21 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/468/979/HD-wallpaper-anime-landscape-falling-stars-sunset-clouds-anime-girl-scenic-anime.jpg" alt="..." />}
                                                {item.id === 31 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/522/207/HD-wallpaper-anime-landscape-houses-scenic-clouds-nature-anime.jpg" alt="..." />}
                                                {item.id === 41 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/14/646/HD-wallpaper-anime-landscape-mountains-scenic-clouds-stars-stream-anime.jpg" alt="..." />}
                                                {item.id === 51 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/624/977/HD-wallpaper-anime-sunset-landscape-scenic-clouds-anime.jpg" alt="..." />}
                                                {item.id === 61 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/102/699/HD-wallpaper-anime-landscape-sunset-house-clouds-sky-scenic-anime.jpg" alt="..." />}
                                                {item.id === 71 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/844/42/HD-wallpaper-anime-landscape-torii-sunset-clouds-scenic-anime.jpg" alt="..." />}
                                                {item.id === 81 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/925/478/HD-wallpaper-anime-landscape-night-scenic-clouds-trees-anime.jpg" alt="..." />}
                                                {item.id === 91 && < img height={"350px"} width={"500px"} src="https://w0.peakpx.com/wallpaper/320/56/HD-wallpaper-anime-landscape-sunset-train-clouds-scenic-fence-anime.jpg" alt="..." />}
